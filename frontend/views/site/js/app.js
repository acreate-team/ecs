$(function() {
	...
	/*
	$('.search_calendar').mouseenter(function() {
		var td = $(this).closest('td');
		var l = td.find('.search_list');
		var w = td.width();
		var wa = $('.calendar_list table').width();

		l.show();
		l.css({'padding-left':w+2+'px', 'width':wa+'px'});
	});
	*/

	var td = $('.search_calendar').closest('td');
	var l = td.find('.search_list');
	var w = td.width();
	var wa = $('.calendar_list table').width();
	l.css({'padding-left':w+2+'px', 'width':wa+'px'});
