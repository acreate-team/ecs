...
<tbody><tr height="18" style="mso-height-source:userset;height:14.1pt;/* border-left: 2pt solid windowtext; */">
 ...
 <tr height="18"<?php if($calendars['table-1']['year'] == $currentYear): ?>class="currentTable" <?php endif; ?>style="mso-height-source:userset;height:14.1pt;border-left: 2pt solid windowtext;border-top: 2pt solid windowtext;">
  ...
  <td colspan="5" data-month="1" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">янв</td>
  <td colspan="4" data-month="2" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">фев</td>
  <td colspan="4" data-month="3" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">мар</td>
  <td colspan="4" data-month="4" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">апр</td>
  <td colspan="5" data-month="5" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">маи</td>
  <td colspan="4" data-month="6" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июн</td>
  <td colspan="5" data-month="7" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июл</td>
  <td colspan="4" data-month="8" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">авг</td>
  <td colspan="4" data-month="9" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">сен</td>
  <td colspan="5" data-month="10" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">окт</td>
  <td colspan="4" data-month="11" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">ноя</td>
  <td colspan="4" data-month="12" data-head="true" data-year="<?=$calendars['table-1']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">дек</td>
 ...
 <tr height="18" style="mso-height-source:userset;height:14.1pt;border-top: 2pt solid windowtext;">
  ...
  <td class="xl125<?php if($date['day'] == $date['daysInMonth']) :?> end-month<?php endif; ?>" style="border-left:none;" data-year="<?=$date['year']?>" data-month="<?=$date['month']?>" data-day="<?=$date['day']?>" data-week-day="<?=$date['week']?>" data-year="<?=$date['year']?>"><?=$date['day']?></td>
  <?php endforeach; ?>
 </tr>
 ...
 <tr height="18"<?php if($calendars['table-2']['year'] == $currentYear): ?>class="currentTable" <?php endif; ?>style="mso-height-source:userset;height:14.1pt;border-top: 2pt solid windowtext;border-bottom: 2pt solid windowtext;">
  ...
  <td colspan="5" data-month="1" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">янв</td>
  <td colspan="4" data-month="2" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">фев</td>
  <td colspan="4" data-month="3" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">мар</td>
  <td colspan="5" data-month="4" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">апр</td>
  <td colspan="4" data-month="5" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">маи</td>
  <td colspan="4" data-month="6" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июн</td>
  <td colspan="5" data-month="7" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июл</td>
  <td colspan="4" data-month="8" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">авг</td>
  <td colspan="4" data-month="9" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">сен</td>
  <td colspan="5" data-month="10" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">окт</td>
  <td colspan="4" data-month="11" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">ноя</td>
  <td colspan="4" data-month="12" data-head="true" data-year="<?=$calendars['table-2']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">дек</td>
 ...
 <tr height="18"<?php if($calendars['table-3']['year'] == $currentYear): ?>class="currentTable" <?php endif; ?>style="mso-height-source:userset;height:14.1pt;border-top: 2pt solid windowtext;border-bottom: 2pt solid windowtext;">
  <td height="18" class="xl90" style="height:14.1pt;border-left: 2pt solid windowtext;border-right: 2pt solid windowtext;">&nbsp;</td>
  <td class="xl106" style="border-left:none;border-right: 2pt solid windowtext;" data-next="true" data-year="<?=$calendars['table-3']['year']?>">→</td>
  <td colspan="4" data-month="1" data-head="true" data-year="<?=$calendars['table-3']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">янв</td>
  <td colspan="4" data-month="2" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">фев</td>
  <td colspan="4" data-month="3" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">мар</td>
  <td colspan="5" data-month="4" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">апр</td>
  <td colspan="4" data-month="5" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">маи</td>
  <td colspan="4" data-month="6" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июн</td>
  <td colspan="5" data-month="7" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июл</td>
  <td colspan="4" data-month="8" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="border-left:none;border-right: 2pt solid windowtext;/* border-bottom: 2pt solid windowtext; */">авг</td>
  <td colspan="5" data-month="9" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="border-right: 2pt solid black;">сен</td>
  <td colspan="4" data-month="10" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">окт</td>
  <td colspan="4" data-month="11" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">ноя</td>
  <td colspan="4" data-month="12" data-head="true" data-year="<?=$calendars['table-3']['year']?>"  class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">дек</td>
...
">&nbsp;</td>
 ...
 <tr height="18"<?php if($calendars['table-4']['year'] == $currentYear): ?>class="currentTable" <?php endif; ?>style="mso-height-source:userset;height:14.1pt;border-top: 2pt solid windowtext;border-bottom: 2pt solid windowtext;">
  ...
  <td class="xl115" data-next="true" data-year="<?=$calendars['table-4']['year']?>" style="
    border-right: 2pt solid windowtext;
">→</td>
  <td colspan="4" data-month="1" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">янв</td>
  <td colspan="4" data-month="2" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">фев</td>
  <td colspan="5" data-month="3" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">мар</td>
  <td colspan="4" data-month="4" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">апр</td>
  <td colspan="4" data-month="5" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">маи</td>
  <td colspan="5" data-month="6" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июн</td>
  <td colspan="4" data-month="7" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">июл</td>
  <td colspan="5" data-month="8" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">авг</td>
  <td colspan="4" data-month="9" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">сен</td>
  <td colspan="4" data-month="10" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">окт</td>
  <td colspan="5" data-month="11" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">ноя</td>
  <td colspan="3" data-month="12" data-head="true" data-year="<?=$calendars['table-4']['year']?>" class="xl149" style="
  border-right: 2pt solid black;
  border-left:
  none;
  ">дек</td>
...
<script>
  ...
  $('td.end-month').each(function(i) {
      ...
      for (var i=0; i < down; i++) {
        trLeft++;
        $(this).closest('table').find('tr:eq('+trLeft+') td:eq('+eqLeft+')').addClass('end-month-right').attr({'data-month':month, 'data-year':year});
      }

      for (var i=0; i < up; i++) {
        tr--;
        $(this).closest('table').find('tr:eq('+tr+') td:eq('+eq+')').addClass('end-month-right').attr({'data-month':month, 'data-year':year});
      }
  });
  ...
  var oldEQ = 0;
  var colspan = 0;
  $('td.end-month[data-week-day="1"], td.end-month-right[data-week-day="1"]').each(function(i) {
    ...
    //$('td[data-head="true"][data-year="'+year+'"][data-month="'+month+'"]').html(colspan);   
    $('td[data-head="true"][data-year="'+year+'"][data-month="'+month+'"]').attr('colspan', colspan);   
  });
